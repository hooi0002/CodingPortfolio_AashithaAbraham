...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, surface, target, bullet_group):
        ...
        if self.alive:
            ...
            # Set the third attr to True to delete bullet clone when collision happens
            ...
            # Check if enemy's health has dropped to 0, switch action to death
            if self.health <= 0:
                # target = castle1
    ...
    def update_animation(self):
        ...
        # Update costume as per the frame_index (costume number)
        self.image = self.animation_list[self.action][self.frame_index]
    ...
    def update_action(self, new_action):
        ...
        if new_action != self.action:
            ...
            # To ensure it starts off the first frame whenever we switch action
            self.frame_index = 0
