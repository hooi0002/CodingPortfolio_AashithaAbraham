...
castle_img_100 = pygame.image.load("PygameAssets/castle/Asset 27.png")
castle_img_60 = pygame.image.load("PygameAssets/castle/Asset 28.png")
castle_img_30 = pygame.image.load("PygameAssets/castle/Asset 29.png")
...
class Castle():
    ...
    def shoot(self):
        ...
        if pygame.mouse.get_pressed()[2]:
            pygame.draw.line(screen, (red, green, blue), (self.rect.center[0], self.rect.center[1]), pos, width=random.randint(0, 15))
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, image, x, y, angle):
        ...
        self.vel_x = 0 # Initial horizontal speed component
